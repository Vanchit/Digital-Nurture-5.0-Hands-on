-- ============================================================
-- Hands on 1: Create the country table in ormlearn schema
-- Run this in MySQL Workbench or mysql CLI:
--   mysql -u root -p ormlearn < country-setup.sql
-- ============================================================
...
-- Step 3: Insert sample records (Hands on 1)
INSERT IGNORE INTO country VALUES ('IN', 'India');
INSERT IGNORE INTO country VALUES ('US', 'United States');

-- ============================================================
-- Hands on 5: Full world country data
-- Delete existing and re-insert all countries
-- ============================================================
DELETE FROM country;
